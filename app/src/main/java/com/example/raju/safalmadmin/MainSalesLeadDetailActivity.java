...
public class MainSalesLeadDetailActivity extends AppCompatActivity {
    ...
    String lead_id;
    SafalmAdmin se;
    private String TAG = MainSalesLeadDetailActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.main_sales_lead_detail_activity);
...
//        });
        ...
        at = new MainSalesLeadDetailActivity.Employee().execute();
...
//        });
    ...
    private class Employee extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(MainSalesLeadDetailActivity.this);
