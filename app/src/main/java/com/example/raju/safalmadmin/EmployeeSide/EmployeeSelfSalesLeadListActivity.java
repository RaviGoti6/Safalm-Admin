...
public class EmployeeSelfSalesLeadListActivity extends AppCompatActivity {
    ...
    private class Employee extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void s) {
            ...
            adptr = new SimpleAdapter(EmployeeSelfSalesLeadListActivity.this, leadList, R.layout.employee_visited_lead_list_item, new String[]{TAG_VLID, TAG_VLNAME, TAG_VLADDRESS, TAG_VLCONTACT, TAG_VLDATE,"product"}, new int[]{R.id.txtVLLIid, R.id.txtVLLIname, R.id.txtVLLIaddress, R.id.txtVLLImobile, R.id.txtVLLIdate,R.id.txtVLLIproduct});
