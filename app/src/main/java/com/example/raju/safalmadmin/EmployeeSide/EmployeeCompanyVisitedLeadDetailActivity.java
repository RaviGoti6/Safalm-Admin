...
public class EmployeeCompanyVisitedLeadDetailActivity extends AppCompatActivity {

    String lead_id;
    SafalmAdmin sa;
    private String TAG = EmployeeCompanyVisitedLeadDetailActivity.class.getSimpleName();

    private ProgressDialog pDialog;
    private static String url = "";
    int flag = 0;
    String id, name, address, contact, email, compname, date_time, date, time, pname, pquantity, pprice, pamount, decision, pid=null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.employee_company_visited_lead_detail_activity);
        ...
        ImageView icCVLDdelete = findViewById(R.id.icCVLDdelete);
        ...
        //Toast.makeText(EmployeeCompanyVisitedLeadDetailActivity.this, "id"+lead_id, Toast.LENGTH_SHORT).show();

        url = "http://10.0.2.2/safalm_admin/employee_company_visited_lead_detail.php?id=" + lead_id;
        ...
        icCVLDedit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i=new Intent(EmployeeCompanyVisitedLeadDetailActivity.this, EmployeeEditVisitedLeadActivity.class);
                ...
                //Toast.makeText(EmployeeCompanyVisitedLeadDetailActivity.this,"Pid="+ pid, Toast.LENGTH_SHORT).show();
        ...
        icCVLDaddsales.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i=new Intent(EmployeeCompanyVisitedLeadDetailActivity.this, EmployeeAddCompanyVisitedLeadToSalesActivity.class);
        ...
        icCVLDaddtask.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(EmployeeCompanyVisitedLeadDetailActivity.this, EmployeeLeadAddToTaskActivity.class);
                i.putExtra("cvlid", id);
                i.putExtra("name", name);
                i.putExtra("address", address);
                i.putExtra("mobile", contact);
        ...
        icCVLDdelete.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                url = "http://10.0.2.2/safalm_admin/employee_delete_company_visited_lead.php?id=" + lead_id;

                new EmployeeCompanyVisitedLeadDetailActivity.Employee().execute();

                Intent i = new Intent(EmployeeCompanyVisitedLeadDetailActivity.this, EmployeeCompanyVisitedLeadListActivity.class);
                startActivity(i);
                finish();
            }
        });
    ...
    private class Employee extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(EmployeeCompanyVisitedLeadDetailActivity.this);
