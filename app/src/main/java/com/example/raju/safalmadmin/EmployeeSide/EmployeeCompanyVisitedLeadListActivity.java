...
public class EmployeeCompanyVisitedLeadListActivity extends AppCompatActivity {
    ...
    int flag = 0;
    SafalmAdmin sa;
    private String TAG = EmployeeCompanyVisitedLeadListActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        url = "http://10.0.2.2/safalm_admin/employee_company_visited_lead_list.php?emp_id=" + empid;
        ...
        list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent i = new Intent(EmployeeCompanyVisitedLeadListActivity.this, EmployeeCompanyVisitedLeadDetailActivity.class);
    ...
    private class Employee extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(EmployeeCompanyVisitedLeadListActivity.this);
