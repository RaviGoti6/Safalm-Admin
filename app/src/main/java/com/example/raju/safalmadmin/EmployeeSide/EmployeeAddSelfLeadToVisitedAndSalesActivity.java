...
public class EmployeeAddSelfLeadToVisitedAndSalesActivity extends AppCompatActivity {

    SafalmAdmin se;
    private String TAG = EmployeeAddSelfLeadToVisitedAndSalesActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.employee_add_self_lead_to_visited_and_sales_activity);
       ...
       // Button btnASLTVSsales = findViewById(R.id.btnASLTVSsales);
        ...
        imgProductList.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            ...
            public void onFocusChange(View v, boolean hasFocus) {
                ...
                if (imgProductList.hasFocus()) {
                    Intent i = new Intent(EmployeeAddSelfLeadToVisitedAndSalesActivity.this, EmployeeProductListActivity.class);
        ...
        editASLTVSdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(EmployeeAddSelfLeadToVisitedAndSalesActivity.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
...
//                        timePicker();
        ...
        editASLTVStime.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                TimePickerDialog timePickerDialog = new TimePickerDialog(EmployeeAddSelfLeadToVisitedAndSalesActivity.this, new TimePickerDialog.OnTimeSetListener() {
                    @Override
        ...
        btnASLTVSvisited.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if ((!date_time.equals("") && !pquantity.equals("") && !pprice.equals("") && !pdetail.equals(""))) {
                    url = "http://10.0.2.2/safalm_admin/employee_add_self_to_visited.php?p_id=" + pid + "&p_quantity=" + quantity + "&p_rate=" + price + "&decision=" + pdetail + "&date_time=" + date_time + "&lead_sid=" + lid + "&emp_id=" + emp_id + "&p_amount=" + amount;
                    new EmployeeAddSelfLeadToVisitedAndSalesActivity.Employee().execute();

                } else {
                    Toast.makeText(EmployeeAddSelfLeadToVisitedAndSalesActivity.this, "All fields are required!!!", Toast.LENGTH_SHORT).show();
                }
...
//                if ((!date_time.equals("") && !pquantity.equals("") && !pprice.equals("") && !pdetail.equals(""))) {
//
//                    url = "http://100.93.150.250/safalm/add_self_to_sales.php?p_id=" + pid + "&p_quantity=" + quantity + "&p_rate=" + price + "&decision=" + pdetail + "&date_time=" + date_time + "&lead_sid=" + lid + "&emp_id=" + emp_id + "&p_amount=" + amount;
...
//        }
    ...
    private class Employee extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(EmployeeAddSelfLeadToVisitedAndSalesActivity.this);
...
//                finish();
                ...
                Toast.makeText(EmployeeAddSelfLeadToVisitedAndSalesActivity.this, "Lead added successfully...", Toast.LENGTH_SHORT).show();
