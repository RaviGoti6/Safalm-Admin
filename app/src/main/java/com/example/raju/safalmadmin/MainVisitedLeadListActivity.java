...
public class MainVisitedLeadListActivity extends AppCompatActivity {
    ...
    int flag = 0;
    SafalmAdmin se;
    private String TAG = MainVisitedLeadListActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.main_visited_lead_list_activity);
        ...
        url = "http://10.0.2.2/safalm_admin/main_visited_lead_list.php";
        // list.setAdapter(null);
        at = new MainVisitedLeadListActivity.Employee().execute();
        ...
        list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent i = new Intent(MainVisitedLeadListActivity.this, MainVisitedLeadDetailActivity.class);
    ...
    private class Employee extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(MainVisitedLeadListActivity.this);
        ...
        protected void onPostExecute(Void s) {
            ...
            adptr = new SimpleAdapter(MainVisitedLeadListActivity.this, leadList, R.layout.visited_lead_list_item, new String[]{TAG_VLID, TAG_VLNAME, TAG_VLADDRESS, TAG_VLCONTACT, TAG_VLDATE,"product"}, new int[]{R.id.txtVLLIid, R.id.txtVLLIname, R.id.txtVLLIaddress, R.id.txtVLLImobile, R.id.txtVLLIdate,R.id.txtVLLIproduct});
