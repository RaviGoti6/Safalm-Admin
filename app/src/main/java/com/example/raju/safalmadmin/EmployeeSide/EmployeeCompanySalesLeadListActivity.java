...
public class EmployeeCompanySalesLeadListActivity extends AppCompatActivity {
    ...
    int flag = 0;
    SafalmAdmin sa;
    private String TAG = EmployeeCompanySalesLeadListActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.employee_company_sales_lead_list_activity);
        ...
        url = "http://10.0.2.2/safalm_admin/employee_company_sales_lead_list.php?emp_id=" + empid;
        ...
        list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent i = new Intent(EmployeeCompanySalesLeadListActivity.this, EmployeeCompanySalesLeadDetailActivity.class);
    ...
    private class Employee extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(EmployeeCompanySalesLeadListActivity.this);
