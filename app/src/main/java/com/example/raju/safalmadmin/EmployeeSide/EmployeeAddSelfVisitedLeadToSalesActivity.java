...
public class EmployeeAddSelfVisitedLeadToSalesActivity extends AppCompatActivity {

    SafalmAdmin se;
    private String TAG = EmployeeAddSelfVisitedLeadToSalesActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.employee_add_self_visited_lead_to_sales_activity);
        ...
        //emp_id = "1";
        emp_id = se.getempId();
        //Toast.makeText(EmployeeAddSelfVisitedLeadToSalesActivity.this, "id="+emp_id, Toast.LENGTH_SHORT).show();
        ...
        btnASVTSaddtosales.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(EmployeeAddSelfVisitedLeadToSalesActivity.this, "id"+vlid, Toast.LENGTH_SHORT).show();
               ...
               // pquantity = editASVTSproductquantity.getText().toString();
                ...
                if ((!date_time.equals("") && !pquantity.equals("") && !pprice.equals("") && !pdetail.equals(""))) {
                    ...
                    url = "http://10.0.2.2/safalm_admin/employee_add_self_visited_to_sales.php?p_id=" + pid + "&p_quantity=" + quantity + "&p_rate=" + pprice + "&decision=" + pdetail + "&date_time=" + date_time + "&v_lead_id=" + vlid + "&emp_id=" + emp_id + "&p_amount=" + pamount;
                    ...
                    new EmployeeAddSelfVisitedLeadToSalesActivity.Employee().execute();
                } else {
                    Toast.makeText(EmployeeAddSelfVisitedLeadToSalesActivity.this, "All fields are required!!!", Toast.LENGTH_SHORT).show();
                }
        ...
        editASVTSdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(EmployeeAddSelfVisitedLeadToSalesActivity.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
        ...
        editASVTStime.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                TimePickerDialog timePickerDialog = new TimePickerDialog(EmployeeAddSelfVisitedLeadToSalesActivity.this, new TimePickerDialog.OnTimeSetListener() {
                    @Override
        ...
        imgProductList.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(EmployeeAddSelfVisitedLeadToSalesActivity.this, EmployeeProductListActivity.class);
    ...
    private class Employee extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(EmployeeAddSelfVisitedLeadToSalesActivity.this);
        ...
        protected void onPostExecute(Void s) {
            ...
            if (contacts.get("success").toString().equals("1")) {
                ...
                Toast.makeText(EmployeeAddSelfVisitedLeadToSalesActivity.this, "Lead added successfully...", Toast.LENGTH_SHORT).show();
            }
