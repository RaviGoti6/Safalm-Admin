...
public class EmployeeEditCompanyLeadActivity extends AppCompatActivity {

    private String TAG = EmployeeEditCompanyLeadActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.employee_edit_company_lead_activity);
        ...
        //Toast.makeText(EmployeeEditCompanyLeadActivity.this, "id="+pid, Toast.LENGTH_SHORT).show();
        ...
        editESLdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(EmployeeEditCompanyLeadActivity.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
...
//                        timePicker();
        ...
        editESLtime.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                TimePickerDialog timePickerDialog = new TimePickerDialog(EmployeeEditCompanyLeadActivity.this, new TimePickerDialog.OnTimeSetListener() {
                    @Override
...
//                mobile=editESLmobile.getText().toString().trim();
                ...
                url = "http://10.0.2.2/safalm_admin/employee_edit_comp_lead.php?lid=" + pid + "&lname=" + name + "&laddress=" + address + "&lmobile=" + mobile+"&lemail="+email+"&lcompany_name="+cmpName+"&ldate="+date_time;
...
//    }
    ...
    private class Employee extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(EmployeeEditCompanyLeadActivity.this);
        ...
        protected void onPostExecute(Void s) {
            ...
            // startActivity(i);
            Toast.makeText(EmployeeEditCompanyLeadActivity.this, "Data Updated Successfully.", Toast.LENGTH_SHORT).show();
            finish();
            pDialog.dismiss();
        }
