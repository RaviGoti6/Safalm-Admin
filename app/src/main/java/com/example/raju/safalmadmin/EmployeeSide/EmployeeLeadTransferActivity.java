...
public class EmployeeLeadTransferActivity extends AppCompatActivity {
    ...
    int flag = 0;
    SafalmAdmin se;
    private String TAG = EmployeeLeadTransferActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.employee_lead_transfer_activity);
        ...
        list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent i = new Intent(EmployeeLeadTransferActivity.this, EmployeeLeadTransferLeadDetailActivity.class);
        ...
        at = new EmployeeLeadTransferActivity.Employee().execute();
    }
    ...
    private class Employee extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(EmployeeLeadTransferActivity.this);
        ...
        protected void onPostExecute(Void s) {
            ...
            adptr = new SimpleAdapter(EmployeeLeadTransferActivity.this, leadList, R.layout.self_lead_list_item, new String[]{TAG_SLID, TAG_SLNAME, TAG_SLADDRESS, TAG_SLCONTACT}, new int[]{R.id.txtSLLIid, R.id.txtSLLIname, R.id.txtSLLIaddress, R.id.txtSLLImobile});
